...
\section{f)}
  ...
  \begin{algorithm}[H]
    ...
    \KwIn{Manège $\G{}$ tel que $\G{} = (\V{},\E{})$ et sommet initiale $u$ tel que $u$ appartien à $\V{}$.}
    \KwResult{Une sequence $S$ de bassins de temps maximal dans le manège \G{}.}
    \BlankLine
    $S \leftarrow [ ]$\;
    $Ttot \leftarrow 0$\;
    $Parent \leftarrow u$\;
